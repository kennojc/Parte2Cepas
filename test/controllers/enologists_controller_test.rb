...
class EnologistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enologist" do
    assert_difference('Enologist.count') do
      post enologists_url, params: { enologist: { age: @enologist.age, country: @enologist.country, name: @enologist.name } }
    end
  ...
  test "should update enologist" do
    patch enologist_url(@enologist), params: { enologist: { age: @enologist.age, country: @enologist.country, name: @enologist.name } }
